...
public class steps extends BaseClass {
	...
	public void setup() throws IOException {
		...
		// replace access key
		String accessKey = "eyJhbGciOiJIUzI1NiJ9.eyJ4cC51Ijo5OTMsInhwLnAiOjEsInhwLm0iOjE2NzA5MzI5NTc1MjcsImV4cCI6MTk4NjI5Mjk1NywiaXNzIjoiY29tLmV4cGVyaXRlc3QifQ.Fq3d-3ogaa1tONXOqBpgEKV3iwgp0AD1uzQPMEk6u2Q";
		//replace url
		String endpoint = "https://commerzbank.experitest.com/wd/hub";
	    DesiredCapabilities dc = new DesiredCapabilities();

		dc.setCapability("testName", "Szczerba Test Static");
